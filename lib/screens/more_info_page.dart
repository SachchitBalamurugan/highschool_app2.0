...
class _MoreInfoState extends State<MoreInfo> {
  ...
  //ChatGPT Link for the case: https://chat.openai.com/c/fd04410e-6e2e-4833-9b82-4adee04b54cf
...
class AnotherEditableText extends StatefulWidget {
  @override
  _AnotherEditableTextState createState() => _AnotherEditableTextState();
}

class _AnotherEditableTextState extends State<AnotherEditableText> {
  TextEditingController _anotherTextEditingController = TextEditingController();

  @override
  Widget build(BuildContext context) {
    return TextField(
      controller: _anotherTextEditingController,
      style: TextStyle(
      ...
      decoration: InputDecoration(
        hintText: "Event Name...",
        hintStyle: TextStyle(
          fontStyle: FontStyle.italic, // Use italic for the hint text
        ),
      ),
      maxLines: null, // Allows for multiline input
      textAlign: TextAlign.start,
  ...
  void dispose() {
    // Clean up the controller when the widget is disposed
    _anotherTextEditingController.dispose();
    super.dispose();
  }
}
